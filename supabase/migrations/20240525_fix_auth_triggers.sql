-- Soluzione completa al problema "Database error granting user"
-- Implementa due trigger che assicurano che ogni utente abbia un profilo
-- 1. Al momento della registrazione (INSERT su auth.users)
-- 2. Al momento del login (INSERT su auth.sessions)

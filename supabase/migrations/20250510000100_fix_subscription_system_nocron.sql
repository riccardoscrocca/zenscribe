...
-- Crea una funzione per eseguire il rinnovo automatico 
...
-- NOTA: Questa parte è rimossa perché l'estensione cron non è disponibile
-- Per implementare il rinnovo automatico, è necessario configurare un job 
-- esterno che chiami la funzione daily_subscription_renewal() ogni giorno.
-- Esempio di comando:
--
-- SELECT daily_subscription_renewal();
--
-- Questo può essere fatto programmando un job su Netlify, una Lambda AWS,
-- o utilizzando l'interfaccia di Supabase per programmare funzioni Edge.
